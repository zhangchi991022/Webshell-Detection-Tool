...
#                               
#########################################################
$name="1";	// логин пользователя
$pass="1";	// пароль пользователя
...
<tr><td valign=top>Хост: </tr><td><input name=adress value='<?php echo$adress?>' size=20></td></tr>
<tr><td valign=top>Порт: </tr><td><input name=port value='<?php echo$port?>' size=6></td></tr>
<tr><Td valign=top>Логин: </td><td><input name=login value='<?php echo$login?>' size=10></td></tr>
<tr><Td valign=top>Пароль: </td><td> <input name=pass value='<?php echo$pass?>' size=10>
<input type=hidden name=p value=sql></td></tr>
<tr><td></td><td><input type=submit name=conn value=Подключиться></form></td></tr><?php}?>
<tr><td valign=top><?php if(@$conn){ echo "<b>PHP v".@phpversion()."<br>mySQL v".@mysql_get_server_info()."<br>";}?></b></td><td>
</td></tr>
</table>
